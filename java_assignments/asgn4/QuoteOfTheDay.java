package java_assignments.asgn4;

import java.lang.Math;

public class QuoteOfTheDay {
    public static void main(String args[]) {
        String[] quotes = new String[]{ // hardcoded quotes stored in an array of strings
        ...
        int len = quotes.length;    // number of quotes
        int idx = (int)(Math.random() * len);   // generating a random index
        System.out.println(quotes[idx]);    // printing a random quote
    }
}
